...
<div class="content_text center">
    <form action="register" method="post">
        <p>
        <h3>Логин:</h3><input name="login" type="text"></input></p>
        <p>
        <h3>Пароль:</h3><input name="password" type="password"></p>
        <p>
        <h3>Повторите пароль:</h3><input name="password_to" type="password"></p><br>
